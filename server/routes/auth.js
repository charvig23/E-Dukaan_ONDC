...
const {getToken,verifyToken}=require("../helper/helper.js");

// <--USERS LOG-IN SIGN-UP ROUTES-->
...
router.post("/register/admin", async (req, res) => {
    ...
    return res.status(200).json({userToReturn, msg: "Admin registered successfully"});
});

//<-- SEPERATE LOGIN ROUTE FOR ADMIN-->
